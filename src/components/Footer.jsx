...
function Footer() {
  ...
  return (
    <footer id="contact" className="relative py-12 overflow-hidden">
      {/* Background elements */}
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-gray-900 to-black"></div>
      ...
      <div className="container mx-auto px-4 relative z-10" ref={ref}>
        ...
        >
            ...
            >
              <div>
                ...
                <input 
                  type="text" 
                  id="name" 
                  className="w-full px-4 py-2 rounded-md bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-300"
          ...
          <div>
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <a href="mailto:your.email@example.com" className="text-gray-400 hover:text-blue-400 transition-colors duration-300">your.email@example.com</a>
                </div>
              </motion.div>
              <motion.div 
                className="flex items-start"
              ...
              >
                ...
                <div>
                  ...
                  <a href="tel:+1234567890" className="text-gray-400 hover:text-blue-400 transition-colors duration-300">+1 (234) 567-890</a>
                </div>
              </motion.div>
              <motion.div 
                className="flex items-start"
            ...
            >
              <h4 className="text-lg font-medium mb-4 text-gray-200">Connect With Me</h4>
